...
DOMean2000  <- download_layers(dataset_id2, 
                               variables = "o2_mean", 
                               constraints = constraints2010)
dataset_id3 <- "thetao_baseline_2000_2019_depthmax"
TempMax2000  <- download_layers(dataset_id3, 
                                variables = "thetao_max", 
                                constraints = constraints2010)
dataset_id4 <- "sws_baseline_2000_2019_depthmax"
SeaVelMax2000  <- download_layers(dataset_id4, 
                                variables = "sws_max", 
                                constraints = constraints2010)
dataset_id5 <- "chl_baseline_2000_2018_depthsurf"
ChlorophyllMax2000  <- download_layers(dataset_id5, 
                                variables = "chl_mean",
                                constraints = constraints2010)
...
MultipleData2000 <- data.frame(terra::extract(SeaIceThickness2000,Coord2000), 
                           terra::extract(TempMax2000,Coord2000), 
                           terra::extract(DOMean2000,Coord2000),
                           terra::extract(SeaVelMax2000,Coord2000),
                           terra::extract(Depth,Coord2000), 
                           terra::extract(ChlorophyllMax2000,Coord2000),
                           x2000Survey$LON, 
                           x2000Survey$LAT, 
                           x2000Survey$wtcpue)

MultipleData2010 <- data.frame(terra::extract(SeaIceThickness2010,Coord2010), 
                           terra::extract(TempMax2010,Coord2010), 
                           terra::extract(DOMean2010,Coord2010),
                           terra::extract(SeaVelMax2010,Coord2010),
                           terra::extract(Depth,Coord2010), 
                           terra::extract(ChlorophyllMax2010,Coord2010),
                           x2010Survey$LON, 
                           x2010Survey$LAT, 
                           x2010Survey$wtcpue)
#Creates new data frame with the latitudes and longitudes removed. 

col_names <- c("sithick_max", "thetao_max","o2_mean", "current_max","chl_ltmax", "depth","lat", "lon", "wtcpue")
...
names(TrainingData)[i] <- col_names[i]
}
...
TrainingData$wtcpue <- NULL
TrainingData$lat <- NULL
TrainingData$lon <- NULL
TrainingData$chl_ltmax <- NULL
