...
png("Figures/PollockMapSidebySide.png", width = 600, height = 400)
...
ggChange <- ggplot() + geom_spatraster(data = Change)+
  colorscheme + labs(title = paste("Change in Predicted CPUE", year,"- 2010)"), caption = "Catch per Unit Effort (CPUE) measured in catch of pollock (kg) per hectare trawled",
